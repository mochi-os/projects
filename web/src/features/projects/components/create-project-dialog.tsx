...
export function CreateProjectDialog({
  ...
  useEffect(() => {
    ...
    if (importClasses.includes('card') || importClasses.includes('checklist')) {
      ...
      importClasses.includes('story') ||
      importClasses.includes('epic') ||
      importClasses.includes('bug')
    ) {
          ...
          <div className='mt-4 space-y-4'>
            ...
            <div className='space-y-2'>
              ...
              <p className='text-muted-foreground text-xs'>
                <Trans>
                  Used for readable IDs like {prefix || 'project'}-1,{' '}
                  {prefix || 'project'}-2
                </Trans>
              </p>
            </div>
            ...
            <div className='mt-4 space-y-3'>
              {importData && importClasses.length > 0 && (
                <div className='bg-primary/10 text-foreground border-primary/20 mb-4 rounded-lg border p-3 text-sm'>
                  ...
                  .{' '}
                  <Trans>
                    We have auto-selected the best matching template.
                  </Trans>
                </div>
              )}
              {isLoadingTemplates ? (
                      ...
                      >
                        ...
                        <div className='flex flex-1 flex-col gap-1.5'>
                          <div className='flex items-center gap-2'>
                            <span className='cursor-pointer text-base leading-none font-semibold'>
                              {template.name}
                            </span>
                            {isSelected && (
